  ...
  return (
    <section className="section-padding bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
          <div>
            ...
            <p className="text-zinc-400 max-w-lg ">
              Discover the perfect vehicle for  you needs, backed by unparalled services and support
            </p>
          </div>
        ...
        {/* SERVICES CARDS */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:px-">
          {/* Services Cards */}
       {
        featuredServices.map((services,index)=>(
